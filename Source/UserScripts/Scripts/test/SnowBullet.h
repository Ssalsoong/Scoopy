...
namespace MMMEngine
{
	...
	public:
		...
		//Todo 시작 설정값 false로 하기 근데 이거 필요없을수도 있음
		bool RunFixedUpdate = true;

		void StartBullet(DirectX::SimpleMath::Vector3 Start_pos, float size, float speed, ObjPtr<GameObject> enemy);
